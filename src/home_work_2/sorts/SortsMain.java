...
public class SortsMain {
    public static void main(String[] args) {
        ...
        System.out.println("Массив после сортировки (пузырьковая) - " + ArraysUtils.arrayToString(array));

        array = new int[]{1,2,3,4,5,6};
        System.out.println("Массив до сортировки - " + ArraysUtils.arrayToString(array));
        SortsUtils.shake(array);
        System.out.println("Массив после сортировки (шейкер) - " + ArraysUtils.arrayToString(array));
        System.out.println("----------------------------------------------------------------------");
