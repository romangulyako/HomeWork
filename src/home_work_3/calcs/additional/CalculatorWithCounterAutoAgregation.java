...
public class CalculatorWithCounterAutoAgregation {
    ...
    /**
     * Конструктор класса CalculatorWithCounterAutoAgregation
    ...
    /**
     * Метод делит одно число на другое с помощью экземпляра класса CalculatorWithMathCopy
    ...
    /**
     * Метод умножает одно число на другое с помощью экземпляра класса CalculatorWithMathCopy
     * и увеличивает счетчик выполненных операций калькулятором на 1
     *
    ...
    /**
     * Метод складывает одно число с другим с помощью экземпляра класса CalculatorWithMathCopy
     * и увеличивает счетчик выполненных операций калькулятором на 1
     *
    ...
    /**
     * Метод отнимает от одного числа другое с помощью экземпляра класса CalculatorWithMathCopy
     * и увеличивает счетчик выполненных операций калькулятором на 1
     *
     * @param x - уменьшаемое
     * @param y - вычитаемое
    ...
    /**
     * Метод возводит дробное число в степень с помощью экземпляра класса CalculatorWithMathCopy
     * и увеличивает счетчик выполненных операций калькулятором на 1
     *
    ...
    /**
     * Метод возвращает модуль числа с помощью экземпляра класса CalculatorWithMathCopy
     * и увеличивает счетчик выполненных операций калькулятором на 1
     *
    ...
    /**
     * Метод вычисляет квадратный корень из числа с помощью экземпляра класса CalculatorWithMathCopy
     * и увеличивает счетчик выполненных операций калькулятором на 1
     *
